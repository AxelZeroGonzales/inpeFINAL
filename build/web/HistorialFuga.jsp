<%-- 
    Document   : HistorialFuga
    Created on : 03-nov-2017, 14:16:21
    Author     : mriveras
--%>
        ...
        <div id="main-wrapper">
            ...
            <div id="content-wrapper">
                ...
                <div class="page-header">
                    <h1 class="col-xs-12 col-sm-4 text-center text-left-sm"><i class="fa fa-check-square page-header-icon"></i>&nbsp;&nbsp;Historial de Fuga de Internos:</h1>
                </div> <!-- / .page-header -->
                <div class="row">
                    <div class="col-sm-12">
                                            ...
                                            <table class="table table-bordered" align="center" cellspacing="2" cellpadding="2" border="1" >
                                                ...
                                                <thead>
                                                    <tr>
                                                        ...
                                                        <th  class="col-md-2 col-form-label text-secondary" align="center">Segundo Apellido</th>
                                                        ...
                                                        <th  class="col-md-2 col-form-label text-secondary" align="center">Observaciones</th>
                                                ...
                                                <tbody>
                                                    <tr ng-repeat="tarea in ctrl.tareas">
                                                        ...
                                                        <td class="col-md-2 col-form-label text-secondary"><fieldset disabled style="border:0px solid"><textarea name="message" style="width: 120px; height: 102px;">{{tarea.texto11}}</textarea></fieldset></td>
                                                        <td class="col-md-2 col-form-label text-secondary"><fieldset disabled style="border:0px solid"><textarea name="message" style="width: 120px; height: 102px;">{{tarea.texto12}}</textarea></fieldset></td>
                                                ...
                                                <div class="modal-dialog modal-lg">
                                                    <div class="modal-content">
                                                        <div class="modal-header">
                                                            ...
                                                            <h4 class="modal-title">Agregar Historial de Fuga</h4>
                                                        </div>
                                                        <div class="modal-body">    
                                                            ...
                                                            <div class="row">
                                                                <div class="col-md-8">
                                                                    <label for="searchField">Observaciones&nbsp;:&nbsp;</label>
                                                                    <textarea id="character-limit-textarea5"  style="width: 690px; height: 102px;" ng-model="ctrl.textoNuevaTarea12"></textarea>
